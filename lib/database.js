  ...
  async createPackageBundle(bundleData) {
    ...
    await this.run(`
      INSERT INTO package_bundles (
        id, name, description, package_id, group_package_id, private_package_id, months_included, price, is_live, live_from, live_until, is_active
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `, [
      id,
      bundleData.name,
      ...
      bundleData.months_included,
      bundleData.price,
      bundleData.is_live !== undefined ? bundleData.is_live : true,
